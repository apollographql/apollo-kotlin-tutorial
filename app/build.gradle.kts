plugins {
    ...
    id("com.apollographql.apollo").version("2.4.3")
}
...
dependencies {
    ...
    implementation("com.apollographql.apollo:apollo-runtime:2.4.3")
    implementation("com.apollographql.apollo:apollo-coroutines-support:2.4.3")
